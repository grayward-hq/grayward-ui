        ...
        <div className="flex w-full items-center gap-4 md:w-auto md:shrink-0">
          ...
          {activeTab === "credentials" && (
            <button
              ...
              disabled
              aria-disabled="true"
              title="Add email coming soon"
              className="flex flex-1 items-center justify-center gap-2 rounded-xl border border-scan-primary-900 px-4 py-3.5 text-base font-semibold text-scan-primary-900 cursor-not-allowed opacity-70 md:flex-none"
            >
          ...
          <button
            ...
            className={cn(
              "flex items-center justify-center gap-2 rounded-xl bg-scan-primary-900 px-5 py-3.5 text-base font-medium text-white opacity-50 cursor-not-allowed",
